    ...
    (function (Items) {
        ...
        var Item = (function (_super) {
            ...
            function Item(model, metadata, geometry, material, position, rotation, scale) {
                ...
                //this.geometry.applyMatrix(new THREE.Matrix4().makeTranslation(-0.5 , -0.5 , -7.5));
                this.geometry.computeBoundingBox();
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var defaultWallTexture = {
            url: "../static/designpage/rooms/textures/wallmap.png",
            stretch: true,
            scale: 0
        };
        /**
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var defaultRoomTexture = {
            url: "../static/designpage/rooms/textures/hardwood.png",
            scale: 400
        };
        /**
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Edge = function (scene, edge, controls) {
            ...
            var texture = null;
            var lightMap = THREE.ImageUtils.loadTexture("../static/designpage/rooms/textures/walllightmap.png");
